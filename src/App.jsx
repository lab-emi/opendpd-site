    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 selection:bg-blue-500/30">
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl text-center">
          ...
          >
            <p className="mb-5 text-sm font-semibold tracking-wide text-cyan-300">OpenDPD 2.2.12 · Available in your browser</p>
            ...
            <p className="mt-7 text-sm text-slate-400">Prefer to run locally? <code className="ml-1 rounded-md bg-slate-900 px-3 py-2 text-slate-200">uv pip install "opendpd==2.2.12" --torch-backend=auto</code></p>
          </Motion.div>
        </div>
      </section>
      ...
      <section id="whats-new" className="py-24 px-6 bg-slate-900/50">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">OpenDPD 2.2.12: reliable PA and DPD training</h2>
            <p className="text-slate-400 text-center mb-12 max-w-2xl mx-auto">
              This maintenance release fixes a startup failure in DeltaGRU PA training.
              Generate signals, simulate a Virtual PA, and train PA or DPD models on shared CUDA compute.
              Download your datasets and trained models to continue locally.
            </p>
          </Motion.div>
